...
public class PostMethodHandler extends MethodHandler {
    ...
    private final String nameMethod = "POST";

    protected PostMethodHandler(SocketService socketService, ResponseCreator responseCreator, ResponseSerializer responseSerializer, Config config) {
    ...
    protected HttpResponse handleInternal(HttpRequest httpRequest) {
        return responseCreator.createResponse(ResponseCode.OK, "<h1>Post method handler</h1>");
    }
}
